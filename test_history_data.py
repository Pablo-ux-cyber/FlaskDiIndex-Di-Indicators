...
def main():
    ...
    try:
        ...
        if len(symbol_data) > 0:
            ...
            print("\n\033[1mВЫВОД:\033[0m")
            if earliest_period[0] > 0 and early_period[0] > 0 and middle_period[0] > 0 and current_period[0] > 0:
                print("\033[32mУСПЕХ: 4-часовые данные отображаются для всех проверенных периодов!\033[0m")
            else:
                print("\033[31mПРОБЛЕМА: 4-часовые данные отсутствуют в некоторых периодах.\033[0m")
